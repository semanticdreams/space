...
if(VCPKG_TARGET_IS_MINGW)
    # Linux-hosted MinGW toolchains use case-sensitive filesystem semantics.
    vcpkg_replace_string("${SOURCE_PATH}/src/assert.cpp" "#include <WinBase.h>" "#include <winbase.h>")
    vcpkg_replace_string("${SOURCE_PATH}/src/assert.cpp" "#include <DbgHelp.h>" "#include <dbghelp.h>")
    # Large translation units can exceed MinGW object section limits in Debug.
