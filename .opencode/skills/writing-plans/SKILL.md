...
After saving the plan and passing self-review, **commit the plan file immediately.** This is a checkpoint — subagent-driven-development will consume the plan but is not responsible for committing it, and the finishing skill will reject a dirty tree:
...
Do not proceed to the execution handoff until the plan is committed.
