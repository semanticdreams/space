...
- Goal: [Core Platform](/dev/features/core-platform) — this pipeline renders all core platform UI
- Feature: [Layout Widget Engine](/dev/features/layout-widget-engine) — the layout system rendered by this pipeline
- [Render Architecture](/dev/notes/render-architecture) — detailed rendering architecture
- [Transform Pass](/dev/notes/transform-pass) — transform pass details
