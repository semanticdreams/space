...
- Goal: [Core Platform](/dev/features/core-platform) — this development model built the core platform
- [Project History](/dev/project/history) — project timeline
- [Fennel Over Python](/dev/adrs/adr-fennel-over-python) — the migration that used this model
