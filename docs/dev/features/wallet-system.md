...
- See: [Subsystems](/dev/subsystems/) — Wallet engine section
- See: [Milestones](/dev/project/milestones/) (Milestone 11 — User-owned services)
- See: [Wallet](/dev/notes/wallet), [Wallet Core](/dev/notes/wallet-core)
