...
4. See [Lifecycle Invariants](/dev/lifecycle-invariants) for the finalized rules
5. See [Lifecycle Hardening Plan](/dev/lifecycle-hardening-plan) for the full strategy

## Related

- [Lifecycle Hardening Plan](/dev/lifecycle-hardening-plan)
- [Lifecycle Invariants](/dev/lifecycle-invariants)
- [Widget Ownership](/dev/widget-ownership-and-teardown)
