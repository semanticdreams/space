...
- [Agent Layer Design](./agent-layer-design) - agent runner, sessions, approvals, OpenCode bridge.
- [Agent Presets](./agent-presets) - context-aware capability and risk model.
- `[Widget Ownership](/dev/widget-ownership-and-teardown).md` - widget ownership and drop rules.
...
Follow `[Widget Ownership](/dev/widget-ownership-and-teardown).md`.
