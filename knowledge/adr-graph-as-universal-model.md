...
- [[graph-foundation]] — current goal to make the graph actually usable
- [[graph-browsing]] — feature for graph navigation/editing
- [[dev-notes/graph-identity]] — identity nodes for stable references
- [[dev-notes/graph-llm]] — graph + LLM integration
- [[adr-composable-states]] — similar explicit-over-implicit philosophy
