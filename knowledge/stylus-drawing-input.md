...
- **Raster layer**: Separate raster backend for brush-based painting (documented in [[dev-notes/drawing-raster-implementation]])
...
- See: [[dev-notes/drawing-architecture]], [[dev-notes/drawing-raster-implementation]]
