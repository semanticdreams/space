...
- Goal: [[core-platform]] — composable states are a core platform input primitive
- Goal: [[graph-foundation]] — graph interaction relies on composable input states
- [[adr-graph-as-universal-model]] — similar philosophy of explicit over implicit
- [[lifecycle-centralization]] — companion decision on ownership
