...
The canonical devlog source lives under `knowledge/journal/*.md`.
...
1. `publish-devlog.mjs` reads each devlog entry from `knowledge/journal/*.md`.
...
- fixture-style coverage using complete sample entries from `knowledge/journal/`
...
- keep `knowledge/journal/*.md` as the canonical authoring format
