...
- `knowledge/dev-notes/agent-layer-design.md` - agent runner, sessions, approvals, OpenCode bridge.
- `knowledge/dev-notes/agent-presets.md` - context-aware capability and risk model.
