...
It is intentionally broader than [[docs/dev/lifecycle-invariants|Lifecycle Invariants]] and
[[docs/dev/widget-ownership-and-teardown]]|Widget Ownership And Teardown.
