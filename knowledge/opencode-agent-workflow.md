...
- Goal: [[core-platform]]
- See: [[agent-runner-system]] — the in-app agent runtime this tool supports
- See: [[docs/dev/opencode-agent-workflow]] — full design document
- See: [[dev-notes/agent-layer-design]]
