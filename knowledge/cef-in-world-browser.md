...
- Goal: [[core-platform]]
- Depends on: [[layout-widget-engine]] — CEF surfaces use the layout engine
- See: [[../README]] (CEF build setup)
- See: [[dev-notes/cef-in-world-browsing]], [[dev-notes/cef-icu-fd-crash]]
