...
- [[terrain-heightfield-system]] — Perlin-noise heightfield with runtime editing and physics
...
- [[subsystems]] — Engine (Physics, Rendering), Widget System (Terrain)
- [[milestones]] (Milestone 3)
- [[history]] — Phase IV was the "world building" month (March 2026)
- Dev notes: [[dev-notes/terrain-architecture]], [[dev-notes/heightfield-terrain-implementation]], [[dev-notes/terrain-selection]], [[dev-notes/terrain-physics-debugging]], [[dev-notes/lighting]]
