...
(fn make-test-ctx []
  ...
  (set ctx.clickables (assert (make-clickables-stub) "LLM conversation messages test context requires clickables"))
  (set ctx.hoverables (assert (make-hoverables-stub) "LLM conversation messages test context requires hoverables"))
