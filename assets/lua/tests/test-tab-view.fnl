...
(fn make-focus-build-ctx []
  ...
  (local clickables (assert (Clickables {:intersectables intersector}) "tab view test context requires clickables"))
  (local hoverables (assert (Hoverables {:intersectables intersector}) "tab view test context requires hoverables"))
