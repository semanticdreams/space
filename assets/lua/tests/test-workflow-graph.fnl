...
(table.insert tests {:name "workflow-definition-load-run-rejects-foreign-definition" :fn (fn [] (with-runtime workflow-definition-load-run-rejects-foreign-definition-case))}) (table.insert tests {:name "workflow-run-explorer-lists-only-definition-runs" :fn (fn [] (with-runtime workflow-run-explorer-lists-only-definition-runs-case))}) (table.insert tests {:name "workflow-run-explorer-preview-search-materializes-one-run" :fn (fn [] (with-runtime workflow-run-explorer-preview-search-materializes-one-run-case))}) (table.insert tests {:name "workflow-run-explorer-preview-drops-owned-children-and-search-listener" :fn (fn [] (with-runtime workflow-run-explorer-preview-drops-owned-children-and-search-listener-case))}) (table.insert tests {:name "workflow-definition-step-items-filter-to-definition" :fn workflow-definition-step-items-filter-to-definition}) (table.insert tests {:name "workflow-definition-load-step-materializes-one-selected-step" :fn workflow-definition-load-step-materializes-one-selected-step}) (table.insert tests {:name "workflow-definition-reveal-all-steps-materializes-steps-and-derived-workflow-edges" :fn workflow-definition-reveal-all-steps-materializes-steps-and-derived-workflow-edges}) (table.insert tests {:name "workflow-definition-open-step-explorer-materializes-ux-node" :fn workflow-definition-open-step-explorer-materializes-ux-node}) (table.insert tests {:name "workflow-step-explorer-preview-search-selects-one-step" :fn workflow-step-explorer-preview-search-selects-one-step})
