...
(fn make-test-ctx []
  ...
  (set ctx.clickables (assert (make-clickables-stub) "LLM chat view test context requires clickables"))
  (set ctx.hoverables (assert (make-hoverables-stub) "LLM chat view test context requires hoverables"))
