...
(fn LightsNodeView [node opts]
  ...
  (fn build [ctx]
    ...
    (assert build-ctx "LightsNodeView requires a build context")
    (local view {})
    (local info-label
      ((Text {:text "Open a light type to add, remove, or edit lights."})
       build-ctx))
    (local search
      ((SearchView {:items []
                    :name "lights-node-view"
                    :num-per-page 10
